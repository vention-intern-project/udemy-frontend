...
export function ForgotPasswordPage() {
  ...
  return (
    <AuthFormShell title="Forgot password" description="Request help signing back in to your account."
      ...
      {success ? (
        ...
        <form className="auth-form__fields" noValidate onSubmit={submit}>
          ...
          <Button type="submit" fullWidth state={mutation.isPending ? 'loading' : 'idle'} loadingLabel="Submitting request...">
            Continue
          </Button>
        </form>
      )}
