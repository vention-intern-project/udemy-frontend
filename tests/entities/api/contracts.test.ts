...
type AuditedOperation = Pick<ApiOperationDefinition, 'id' | 'method' | 'path' | 'requestMode' | 'responseMode'>;
...
const AUDITED_OPERATION_TABLE = [
  ...
  { id: 'API-004', method: 'POST', path: '/cart/checkout', requestMode: 'none', responseMode: 'json' },
  { id: 'API-005', method: 'POST', path: '/cart/items', requestMode: 'json', responseMode: 'json' },
  { id: 'API-006', method: 'DELETE', path: '/cart/items/:courseId', requestMode: 'none', responseMode: 'void' },
  ...
  { id: 'API-010', method: 'GET', path: '/courses/:courseId', requestMode: 'none', responseMode: 'json' },
  { id: 'API-011', method: 'PATCH', path: '/courses/:courseId', requestMode: 'json', responseMode: 'json' },
  { id: 'API-012', method: 'DELETE', path: '/courses/:courseId', requestMode: 'none', responseMode: 'json' },
  { id: 'API-013', method: 'GET', path: '/courses/:courseId/enrollments', requestMode: 'query', responseMode: 'json' },
  { id: 'API-014', method: 'GET', path: '/courses/:courseId/lessons', requestMode: 'query', responseMode: 'json' },
  { id: 'API-015', method: 'POST', path: '/courses/:courseId/lessons', requestMode: 'json', responseMode: 'json' },
  { id: 'API-016', method: 'DELETE', path: '/courses/:courseId/lessons/:lessonId', requestMode: 'none', responseMode: 'json' },
  { id: 'API-017', method: 'POST', path: '/courses/:courseId/lessons/:lessonId/complete', requestMode: 'none', responseMode: 'json' },
  { id: 'API-018', method: 'POST', path: '/courses/:courseId/lessons/:lessonId/incomplete', requestMode: 'none', responseMode: 'json' },
  { id: 'API-019', method: 'GET', path: '/courses/:courseId/progress', requestMode: 'none', responseMode: 'json' },
  { id: 'API-020', method: 'POST', path: '/enrollments', requestMode: 'json', responseMode: 'json' },
  { id: 'API-021', method: 'GET', path: '/enrollments/my', requestMode: 'query', responseMode: 'json' },
  { id: 'API-022', method: 'GET', path: '/enrollments/:enrollmentId', requestMode: 'none', responseMode: 'json' },
  { id: 'API-023', method: 'POST', path: '/forgot-password', requestMode: 'json', responseMode: 'json' },
  { id: 'API-024', method: 'POST', path: '/login', requestMode: 'json', responseMode: 'json' },
  { id: 'API-025', method: 'GET', path: '/media/lessons/:filename', requestMode: 'none', responseMode: 'binary' },
  { id: 'API-026', method: 'GET', path: '/me', requestMode: 'none', responseMode: 'json' },
  { id: 'API-029', method: 'POST', path: '/reset-password', requestMode: 'json', responseMode: 'json' },
  { id: 'API-030', method: 'GET', path: '/lessons/:lessonId', requestMode: 'none', responseMode: 'json' },
...
describe('selected backend operation contracts', () => {
  ...
  it('matches the audited method, path, request, response, and DTO association table', () => {
    expect(API_OPERATIONS.map(({ id, method, path, requestMode, responseMode }) => ({
      id,
      method,
      path,
      requestMode,
  ...
  it('attaches machine-readable assumption tags only to affected contracts', () => {
    ...
    expect(API_OPERATION_BY_ID['API-012'].assumptionTags).toContain(CONTRACT_ASSUMPTIONS.GAP_003.code);
    expect(API_OPERATION_BY_ID['API-008'].assumptionTags).toContain(CONTRACT_ASSUMPTIONS.GAP_007.code);
